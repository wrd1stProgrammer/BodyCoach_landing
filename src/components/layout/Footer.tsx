            ...
            <div className={`main-container ${styles.footerContainer}`}>
                ...
                <div className={styles.brandColumn}>
                    ...
                    <div className={styles.storeButtons}>
                        <a href="https://apps.apple.com/kr/app/bodycoach-ai-diet-workout-log/id6756229086?l=en-GB" target="_blank" rel="noopener noreferrer">
                            <img src="/appstore.png" alt="Download on the App Store" className={`${styles.storeBadge} ${styles.appleBadge}`} />
                        </a>
                        <a href="https://play.google.com/store/apps/details?id=com.bodycode" target="_blank" rel="noopener noreferrer">
            ...
            <div className={styles.bottomBarWrapper}>
                <div className={`main-container ${styles.bottomBar}`}>
                    ...
                    <div className={styles.socialLinks}>
                        <a href="https://www.instagram.com/bodycoach_ai/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                        ...
                        <a href="https://x.com/bodycode_" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
